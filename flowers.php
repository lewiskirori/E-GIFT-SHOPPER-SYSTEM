            ...
            $userEmail = ""; 
                if(isset($_POST['subscribe'])){//if subscribe btn is clicked
                    ...
                    if(filter_var($userEmail, FILTER_VALIDATE_EMAIL)){//validating user input email
                        $subject = "Thanks for subscribing us - Flowers 💐";
                        $message    = "Thanks for subscrbing to our gift shop. You will always receive latest gift updates on Flowers from us!<br> Regards, Administrator. </br>";
